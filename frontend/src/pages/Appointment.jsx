...
const Appointment = () => {
  ...
  const getAvailableSlot = () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      //setting endime of the date with index
      ...
      while (currentDate < endTime || currentDate === endTime) {
