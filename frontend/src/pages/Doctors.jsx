    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        <button
          ...
          className={`px-1 py-3 border rounded text-sm transition-all sm:hidden ${
        ...
        <div className="w-full grid grid-cols-auto gap-4 gap-y-6">
          {filterdDoc.map((item, index) => (
            <div
              ...
              key={index}
              className="border border-blue-200 rounded-2xl overflow-hidden cursur-pointer hover:translate-y-[-10px] transition-all duration-500 "
            >
